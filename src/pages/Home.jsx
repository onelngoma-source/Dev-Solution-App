...
const Home = () => {
  return (
    // FIX 1: "bg-transparent" au lieu de "bg-darkbg" pour voir la 3D derrière
    <div className="w-full bg-transparent overflow-hidden relative">
      ...
      <div className="container mx-auto px-6 md:px-20 mb-32 relative z-10">
          ...
          <div className="grid md:grid-cols-3 gap-8">
              {/* Carte 1 */}
              <GlassCard className="group hover:-translate-y-2 transition-all duration-300 hover:shadow-[0_0_30px_rgba(59,130,246,0.2)] hover:border-blue-500/50">
              ...
              <GlassCard className="group hover:-translate-y-2 transition-all duration-300 border-neon/30 bg-neon/5 hover:shadow-[0_0_30px_rgba(0,255,136,0.2)] hover:border-neon">
              ...
              {/* Carte 3 */}
              <GlassCard className="group hover:-translate-y-2 transition-all duration-300 hover:shadow-[0_0_30px_rgba(168,85,247,0.2)] hover:border-purple-500/50">
      ...
      <div className="container mx-auto px-6 md:px-20 mb-32">
          ...
          <div className="grid gap-16">
              ...
              <GlassCard className="grid md:grid-cols-2 gap-8 items-center group hover:border-orange-500/50 transition-all duration-500 hover:bg-white/5">
                  ...
                  <div className="order-1 md:order-2 rounded-xl overflow-hidden border border-white/10 relative">
