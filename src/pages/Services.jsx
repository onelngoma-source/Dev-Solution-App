...
const Services = () => {
  ...
  return (
    <div className="w-full bg-transparent overflow-hidden relative pt-32 pb-20">
        ...
        {/* --- FIX LUMIÈRE : EXACTEMENT COMME SUR L'ACCUEIL --- */}
        ...
        {/* --- 2. CONTENU PRINCIPAL --- */}
        <div className="container mx-auto px-6 md:px-20 grid md:grid-cols-2 gap-16 items-center min-h-[500px] animate-fade-in relative z-10">
            
            {/* GAUCHE : TEXTE & CHECKLIST */}
            <div>
            ...
            {/* DROITE : CARTE STACK (Version Verre) */}
            <div className="relative group">
                ...
                <GlassCard className="relative p-10 border border-white/20 bg-black/60 backdrop-blur-xl">
        ...
        <div className="container mx-auto px-6 md:px-20 mt-32 text-center relative z-10">
             ...
             <button className="bg-[#5c7c8a]/30 hover:bg-neon hover:text-black text-white border border-white/20 font-bold py-4 px-12 rounded-lg transition-all uppercase tracking-widest shadow-lg flex items-center gap-2 mx-auto group">
