...
const Contact = () => {
  ...
  return (
    // FIX 1: bg-transparent + overflow-hidden + min-h-screen
    <div className="pt-32 pb-20 px-6 md:px-20 w-full bg-transparent overflow-hidden relative min-h-screen">
      
      {/* FIX 2: LA LUMIÈRE NÉON GLOBALE (Comme les autres pages) */}
      ...
      <div className="container mx-auto grid lg:grid-cols-12 gap-10 relative z-10">
        ...
        <div className="lg:col-span-4 space-y-8">
            ...
            {/* 1. CARTE CONTACTS DIRECTS (Version brillante) */}
            <GlassCard className="space-y-8 border border-white/10 bg-black/40 backdrop-blur-xl hover:border-neon/30 transition-colors">
                ...
                <div className="flex items-start gap-4 group cursor-pointer">
                    <div className="p-3 rounded-xl bg-white/5 text-white group-hover:bg-neon group-hover:text-black transition-all shadow-[0_0_10px_rgba(255,255,255,0.05)] group-hover:shadow-[0_0_15px_rgba(0,255,136,0.4)]">
                        <FaPhoneAlt />
                    </div>
                    <div>
                        <div className="text-[9px] text-gray-500 uppercase tracking-wider font-mono mb-1">Appel Direct (24/7)</div>
                        <div className="text-lg font-bold text-white group-hover:text-neon transition-colors font-mono">+241 74 81 51 93</div>
                    </div>
                </div>
                ...
                <div className="flex items-start gap-4 group cursor-pointer">
                    ...
                    <div>
                        ...
                        <div className="text-sm font-bold text-white group-hover:text-neon transition-colors font-mono break-all">devssolutions.tech@gmail.com</div>
                    </div>
                </div>
                ...
                <div className="flex items-start gap-4 group cursor-pointer">
                    ...
                    <div>
                        ...
                        <div className="text-lg font-bold text-white group-hover:text-neon transition-colors font-mono">Démarrer le chat</div>
                    </div>
                </div>
            </GlassCard>

            {/* 2. CYBER MAP (Version améliorée, plus lumineuse) */}
            <div className="rounded-3xl border border-neon/20 bg-black/50 backdrop-blur-md h-72 relative overflow-hidden group shadow-[0_0_20px_rgba(0,255,136,0.1)]">
                {/* Grille de fond Néon */}
        ...
        {/* COLONNE DROITE : FORMULAIRE TERMINAL (Plus brillant) */}
            ...
            <GlassCard className="h-full relative overflow-hidden border border-white/10 bg-black/40 backdrop-blur-xl p-8 md:p-12 hover:border-neon/30 transition-colors">
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        {/* INPUT NOM (Style Verre + Focus Néon) */}
                        <div className="group relative">
                            ...
                            />
                            {/* Petite ligne décorative au focus */}
                    ...
                    <div className="group relative">
                        ...
                        <select className="w-full bg-white/5 border border-white/10 rounded-xl p-5 text-gray-300 focus:outline-none focus:border-neon focus:bg-black/60 focus:shadow-[0_0_20px_rgba(0,255,136,0.2)] transition-all font-mono text-sm appearance-none backdrop-blur-md cursor-pointer">
                            <option className="bg-darkbg">Développement Web / Mobile</option>
                            <option className="bg-darkbg">Maintenance & Infra</option>
                            <option className="bg-darkbg">Solution I.A.</option>
                            <option className="bg-darkbg">Autre / Partenariat</option>
                        </select>
                        <div className="absolute bottom-0 left-1/2 w-0 h-[2px] bg-neon group-focus-within:w-full group-focus-within:left-0 transition-all duration-500"></div>
                    </div>
