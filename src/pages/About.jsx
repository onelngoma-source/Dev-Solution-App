  ...
  return (
    <div className="w-full bg-transparent overflow-hidden relative pt-32 pb-20">
        ...
        <div className="container mx-auto px-6 md:px-20 mb-32">
            <GlassCard className="grid md:grid-cols-2 gap-12 items-center p-8 md:p-12 relative overflow-hidden group border border-white/10 bg-black/40 backdrop-blur-xl">
                {/* Texte Gauche */}
                ...
                {/* Image Droite (Code Screen) */}
                <div className="relative h-full min-h-[300px] rounded-xl overflow-hidden border border-white/10 bg-[#050505] shadow-2xl">
        ...
        <div className="container mx-auto px-6 md:px-20 mb-32 relative z-10">
            ...
            <div className="grid md:grid-cols-4 gap-6">
                {[
                    ...
                    <GlassCard key={i} className="hover:-translate-y-2 transition-all duration-300 hover:bg-white/5 group border border-white/5">
        ...
        <div className="container mx-auto px-6 md:px-20 mb-32 relative z-10">
            ...
            <div className="grid md:grid-cols-2 gap-8">
                {/* 1. PIXELS LABS (ROSE) */}
                <div className="bg-[#0a0a0a]/80 border border-pink-500/20 p-8 rounded-2xl relative overflow-hidden group hover:border-pink-500/60 transition-colors backdrop-blur-md">
                    <div className="absolute -right-6 -top-6 p-4 opacity-10 group-hover:opacity-20 transition-opacity rotate-12"><FaPalette size={100} className="text-pink-500"/></div>
                ...
                {/* 2. CODE OPS (BLEU) */}
                <div className="bg-[#0a0a0a]/80 border border-blue-500/20 p-8 rounded-2xl relative overflow-hidden group hover:border-blue-500/60 transition-colors backdrop-blur-md">
                    <div className="absolute -right-6 -top-6 p-4 opacity-10 group-hover:opacity-20 transition-opacity rotate-12"><FaCode size={100} className="text-blue-500"/></div>
                ...
                {/* 3. R&D LAB (VERT) */}
                <div className="bg-[#0a0a0a]/80 border border-neon/20 p-8 rounded-2xl relative overflow-hidden group hover:border-neon/60 transition-colors backdrop-blur-md">
                    <div className="absolute -right-6 -top-6 p-4 opacity-10 group-hover:opacity-20 transition-opacity rotate-12"><FaFlask size={100} className="text-neon"/></div>
                ...
                {/* 4. CASH FLOW (ORANGE) */}
                <div className="bg-[#0a0a0a]/80 border border-orange-500/20 p-8 rounded-2xl relative overflow-hidden group hover:border-orange-500/60 transition-colors backdrop-blur-md">
                    <div className="absolute -right-6 -top-6 p-4 opacity-10 group-hover:opacity-20 transition-opacity rotate-12"><FaChartLine size={100} className="text-orange-500"/></div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8 relative z-10">
                    {[
                        ...
                        <div key={index} className="flex flex-col items-center text-center group">
                            <div className="w-12 h-12 rounded-full bg-[#050505] border border-white/20 group-hover:border-neon group-hover:text-neon group-hover:shadow-[0_0_15px_rgba(0,255,136,0.5)] flex items-center justify-center text-sm font-bold transition-all duration-300 mb-6 relative z-10">
                                {item.step}
                            </div>
                            <h3 className="text-xs font-bold text-white mb-1 uppercase tracking-widest">{item.title}</h3>
