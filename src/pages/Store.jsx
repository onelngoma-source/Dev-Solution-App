...
import Reveal from '../components/Reveal'; // AJOUTÉ
...
const Store = () => {
  ...
  return (
    ...
    <div className="w-full bg-transparent overflow-hidden relative pt-32 pb-20 perspective-1000">
        ...
        {/* --- AJOUT: DÉCORATIONS VIVANTES (BULLES) --- */}
        <div className="absolute top-20 left-0 w-64 h-64 bg-neon/10 rounded-full blur-[80px] animate-pulse -z-10 pointer-events-none"></div>
        <div className="absolute bottom-40 right-10 w-40 h-40 bg-purple-500/10 rounded-full blur-[60px] animate-bounce duration-[8000ms] -z-10 pointer-events-none"></div>
        ...
        <div className="container mx-auto px-6 md:px-20 mb-32 relative z-10">
            <div className="grid md:grid-cols-2 gap-16 items-center">
                ...
                <div>
                    ...
                    <Reveal delay={600}>
                        <div className="flex gap-4 mb-10">
                            <button className="flex items-center gap-3 bg-neon text-black font-bold py-4 px-8 rounded-xl hover:shadow-[0_0_20px_rgba(0,255,136,0.6)] hover:-translate-y-1 transition-all duration-300 group">
                                <FaAndroid size={24} className="group-hover:scale-110 transition-transform"/> 
                ...
                {/* DROITE : TÉLÉPHONE PRINCIPAL (FLOTTANT) */}
                <div className="relative flex justify-center perspective-1000 animate-float"> {/* <--- FLOTTEMENT */}
                     ...
                     <div className="relative z-10 w-[280px] h-[580px] bg-black rounded-[45px] border-4 border-gray-800 shadow-2xl overflow-hidden transform transition-transform duration-500 hover:rotate-y-6 hover:rotate-x-6">
                        {/* Notch */}
                     ...
                     <Reveal delay={1000} className="absolute bottom-20 -left-10 z-20">
                         <GlassCard className="p-4 flex items-center gap-3 animate-bounce shadow-xl bg-black/60 backdrop-blur-xl border-neon/30">
        ...
        <div className="container mx-auto px-6 md:px-20 mb-32 relative z-10">
            ...
            <div className="grid md:grid-cols-2 gap-6">
                {/* Carte 1 */}
                <Reveal delay={100}>
                    <div className="bg-[#0a0a0a]/80 p-8 rounded-2xl border border-white/10 flex items-start gap-5 hover:border-blue-500/40 transition-colors group backdrop-blur-md h-full">
                ...
                {/* Carte 2 */}
                <Reveal delay={200}>
                    <div className="bg-[#0a0a0a]/80 p-8 rounded-2xl border border-white/10 flex items-start gap-5 hover:border-neon/40 transition-colors group backdrop-blur-md h-full">
                ...
                {/* Carte 3 */}
                <Reveal delay={300}>
                    <div className="bg-[#0a0a0a]/80 p-8 rounded-2xl border border-white/10 flex items-start gap-5 hover:border-purple-500/40 transition-colors group backdrop-blur-md h-full">
                ...
                {/* Carte 4 */}
                <Reveal delay={400}>
                    <div className="bg-[#0a0a0a]/80 p-8 rounded-2xl border border-white/10 flex items-start gap-5 hover:border-orange-500/40 transition-colors group backdrop-blur-md h-full">
        ...
        {/* --- 4. INSTALLATION IMMEDIATE --- */}
        <div className="container mx-auto px-6 md:px-20 relative z-10">
            <Reveal className="bg-white rounded-[30px] p-10 md:p-12 flex flex-col md:flex-row items-center justify-between shadow-2xl relative overflow-hidden">
